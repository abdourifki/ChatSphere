    ...
    <>
      <div className="chat-img h-screen flex justify-center items-center ">
        ...
        <div
          ...
          className="  bg-white p-6 rounded-lg border border-[#e5e7eb] w-[440px] h-[634px]"
        >
          {/* Heading */}
          <div className="flex flex-col space-y-1.5 pb-6">
            <h2 className="font-semibold text-lg tracking-tight">ChatSphere</h2>
          </div>
        ...
        {inbox.map((msg: string, index: number) => (
